            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>Mission</h3>
                        <p> <a href="index.php">Home</a> / Mission</p>
                    </div>
                </div>
            </div>
        </div>
...
<h3>The Mission</h3>
<p style="text-align: justify;">To pave the way for the word of God to be fruitfully and bountifully cast into the hearts and lives of the men and women in uniform, government workers, private and public sectors and to the community by training and deploying Speaker’s Bureau throughout the country.</p>
                            </div>
                        </div>
                    </div>
                </div>
