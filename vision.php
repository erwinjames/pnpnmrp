            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>Vision</h3>
                        <p> <a href="index.php">Home</a> / Vision</p>
                    </div>
                </div>
            </div>
        </div>
...
<h3>The Vision</h3>
<p style="text-align: justify;">An effective Moral and Spiritual Recovery Program for the Philippine National Police, Government Agencies, National and Local Government Units, Private and Public Sectors of society, and the Filipino people  as a whole.</p>
                            </div>
                        </div>
                    </div>
                </div>
